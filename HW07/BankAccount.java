...
public class BankAccount {
	...
	if (newPin>=1000 && newPin<=9999){
        ...
        System.out.println("Your number is invalid. Pin must be in interval [1000, 9999].");
	return oldPin;
	...
	if (newAcctNum >=100000000 && newAcctNum <=999999999){
	    ...
	    System.out.println("Error. Account number must be in interval [100000000, 999999999].");
	    return oldAcctNum;
